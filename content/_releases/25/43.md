...
We have introduced a new feature to enhance debugging capabilities for [scheduled execution]({{site.data.tenant.apiDocsUri}}/v2#/scheduled%20executions) and [retrieve sample]({{site.data.tenant.apiDocsUri}}/v2#/flows/post_flows_start_debug). 
