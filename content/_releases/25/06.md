...
Implemented a [search functionality]({{site.data.tenant.apiDocsUri}}/v2#/recipes/get_recipes) enhancement for the `GET v2/recipes` endpoint, allowing users to search for Recipes based on a specific word or phrase contained within the recipe title.
