...
*   **REMOVED** `thatapp-node` library from deprecated actions and triggers to address a bug introduced in version 2.2.1. 
*   **UPDATED** `Sailor` version to `2.7.6`
*   **UPDATED** `component-commons-library` version to `4.0.0`

### [Square component](/components/square/) `1.1.0`
*   **ADDED** `Get New and Updated Objects Polling` Trigger
*   **ADDED** `Lookup Objects (plural)` Action
*   **REMOVED** `thatapp-node` library from deprecated actions and triggers. 
*   **UPDATED** `Sailor` version to `2.7.6`
*   **UPDATED** `component-commons-library` version to `4.0.0`
