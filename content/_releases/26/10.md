...
_Note: When the quota is exceeded, all flows in the contract will be suspended. They can be resumed by {{site.data.tenant.name}} Support upon a request to increase the resource limit._
...
*   **UPDATED** `thatapp-sailor-nodejs`dependencies to `2.7.7`
*   **UPDATED** CircleCI configuration
*   **REMOVED** `thatapp-node` and `amqplib` dependencies
*   **IMPROVED** `README.md`
...
*   **UPDATED** `thatapp-rest-node` to `v2.0.0`
*   **REMOVED** `nsprc` file
...
### [Sailor Nodejs](https://www.npmjs.com/package/thatapp-sailor-nodejs/v/2.7.8) `2.7.8`
