...
Conducted an investigation into the feasibility of migrating the thatapp.io platform to ARM-based processors.
...
*   **UPDATED** dependencies:
    *   `thatapp-sailor-nodejs` version from `2.7.4` to `2.7.8`
    *   `@thatapp.io/component-commons-library` version from `3.2.1` to `4.0.0`
...
*   **FIXED** [issue-22](https://github.com/thatapp/soap-component/issues/22) in document type WSDLs
