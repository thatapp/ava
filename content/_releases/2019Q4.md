...
The  official registry (`registry:2.7.1` or mirror `thatapp/registry:2.7.1`)
is being run as a `root`, `thatapp/registry:2.7.1-non-root` is being  run as
                ...
                "containers": [
                    {
                        ...
                        "image": "thatapp/registry:2.7.1-non-root",
