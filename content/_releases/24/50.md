...
[Sailor-NodeJS](https://www.npmjs.com/package/thatapp-sailor-nodejs) has been upgraded to v2.7.4 to fix error location when a component uses the Rebound functionality.
...
*   **UPDATED** `@thatapp.io/component-commons-library` to `3.2.1`
