...
_Please contact our [support](mailto:{{site.data.tenant.supportEmail}}) if your contract needs to change the limit._
...
* [v2/tenants/:id]({{site.data.tenant.apiDocsUri}}/docs/v2#/tenants)
* [v2/contracts/:id]({{site.data.tenant.apiDocsUri}}/docs/v2#/contracts)
