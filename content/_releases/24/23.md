...
With the new API endpoint `{{site.data.tenant.apiDocsUri}}/v2#/flows/delete_flows_subscription`, users can now unsubscribe from flow errors across all their flows or specifically within a specific workspace. 
