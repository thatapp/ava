...
- [Update Tenant’s roles]({{site.data.tenant.apiDocsUri}}/v2#/tenants/patch_tenants__tenant_id__roles)
...
- [Get the list of available permissions]({{site.data.tenant.apiDocsUri}}/v2#/permissions/get_permissions)
- [Get Tenant’s roles]({{site.data.tenant.apiDocsUri}}/v2#/tenants/get_tenants) and [Update Tenant’s roles]({{site.data.tenant.apiDocsUri}}/v2#/tenants/patch_tenants__tenant_id__roles)
